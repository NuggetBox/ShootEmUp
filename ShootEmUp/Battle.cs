...
namespace ShootEmUp
{
    class Battle : State
    {
        ...
        public override void Initialize()
        {
            ...
            {
                new Player(true) { myStartPos = new Vector2(320, 360), mySpeed = 280, myRotationSpeed = 3.5f, myOriginalAttackCooldown = 0.15f, myHealth = 25, myBulletSpeed = 450 },
                ...
                new Player(false) { myUp = Keys.Up, myDown = Keys.Down, myRight = Keys.Right, myLeft = Keys.Left,
                    ...
                    myStartPos = new Vector2(960, 360), mySpeed = 280, myRotationSpeed = 3.5f, myOriginalAttackCooldown = 0.15f, myHealth = 25, myBulletSpeed = 450 }
            };
